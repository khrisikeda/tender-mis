...
tenders = [
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Supply and installation of ECG machines", "security_rwf": 982526, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 2, "name": "Supply and installation of Trolley mounted Patient monitors", "security_rwf": 5449149, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 3, "name": "Supply and installation of Wall mounted Patient monitors", "security_rwf": 4105410, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 4, "name": "Supply and installation of Central Monitor Station", "security_rwf": 9201448, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 5, "name": "Supply and installation of Holter Monitors with carrying pouch", "security_rwf": 3856008, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 6, "name": "Supply and installation of Defibrillators and Digital Colposcopy machine", "security_rwf": 5832212, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 7, "name": "Supply and installation of Mobile CTG -systems", "security_rwf": 1521611, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" },
      { "lot_no": 8, "name": "Supply and installation of Wall mounted CTG -systems", "security_rwf": 3695341, "place": "CHUK Masaka", "delivery_days": 120, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "ECG Leads & Analysis", "req": "Standard 12-lead simultaneous acquisition with Glasgow algorithm", "sup": "12-lead simultaneous acquisition, Glasgow interpretation algorithm", "status": "COMPLIANT", "notes": "Fully compliant" },
          { "param": "Display & Printer", "req": "Color display >= 8 inch with internal thermal printer", "sup": "8.9-inch high-resolution color touchscreen + 216mm thermal printer", "status": "COMPLIANT", "notes": "Exceeds standard" }
        ]
      },
      {
        "lot_id": "Lot 2 & 3",
        ...
        "specs_matrix": [
          { "param": "Display", "req": "Touchscreen >= 12.1-inch color LCD display", "sup": "15-inch capacitive anti-glare touchscreen", "status": "COMPLIANT", "notes": "Exceeds required display size" },
          { "param": "Hemodynamic Parameters", "req": "ECG, SpO2, NIBP, 2-Temp, Respiration, Arrhythmia analysis", "sup": "Mindray CrozFusion ECG/SpO2 synergistic algorithm with 25 arrhythmia classifications", "status": "COMPLIANT", "notes": "Clinical grade precision" }
        ]
      },
      {
        "lot_id": "Lot 4",
        ...
        "specs_matrix": [
          { "param": "Bedside Connectivity", "req": "Minimum 32 bedside monitors simultaneous live review", "sup": "Scalable up to 64 beds with dual 24-inch medical displays", "status": "COMPLIANT", "notes": "Exceeds specification" }
        ]
      },
      {
        "lot_id": "Lot 6",
        ...
        "specs_matrix": [
          { "param": "Energy Selection", "req": "Biphasic truncated exponential 1J to 360J", "sup": "360B biphasic waveform with 3-second quick charge", "status": "COMPLIANT", "notes": "Full compliance" }
        ]
      }
    ],
    ...
    "compliance_checklist": [
      { "item": "Valid Rwanda FDA Wholesale License", "status": "VALID", "note": "Active until Dec 2027" },
      { "item": "ISO 13485:2016 Manufacturer Certificate", "status": "VALID", "note": "Certified by TÜV SÜD" },
      { "item": "RPPA Tax Clearance & RSSB Compliance", "status": "VALID", "note": "Generated electronically via RRA" },
      { "item": "Manufacturer Authorization Form (MAF)", "status": "VALID", "note": "Mindray authorized distributor agreement on file" },
      { "item": "Tender Security Guarantee (RWF 34,643,705)", "status": "VALID", "note": "Bank guarantee issuance available with BPR / I&M Bank" }
    ],
    "missing_products": [],
  ...
  },
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Supply and installation of Medical Air Compressor for ICU and Neonatalogy", "security_rwf": 2850000, "place": "RL2TH Hospital", "delivery_days": 15, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "Compressor Technology", "req": "100% Oil-free scroll or reciprocating duplex system", "sup": "Duplex oil-free scroll compressor with automatic alternating duty", "status": "COMPLIANT", "notes": "Zero oil contamination guarantee" },
          { "param": "Filtration & Air Purity", "req": "Air purity compliant with European Pharmacopoeia / ISO 8573-1", "sup": "5-stage filtration with desiccant dryer (-40°C pressure dew point)", "status": "COMPLIANT", "notes": "Hospital medical grade" }
        ]
      }
    ],
    "brand_equivalence_matrix": [
    ...
    "compliance_checklist": [
      { "item": "Valid Rwanda FDA Wholesale License", "status": "VALID", "note": "Active" },
      { "item": "ISO 13485:2016 Manufacturer Certificate", "status": "VALID", "note": "Certified" },
      { "item": "Tender Security Guarantee (RWF 2,850,000)", "status": "VALID", "note": "Ready for issuance" }
    ],
    "missing_products": [],
  ...
  },
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Supply of Medical Equipment", "security_rwf": 3200000, "place": "Ruli DH", "delivery_days": 30, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "Vital Signs Monitoring", "req": "NIBP, SpO2, Pulse Rate, Infrared Temp with rechargeable battery", "sup": "Mindray VS-600 with Li-ion battery >= 11 hours", "status": "COMPLIANT", "notes": "Compliant" }
        ]
      }
    ],
    "brand_equivalence_matrix": [
    ...
    "compliance_checklist": [
      { "item": "Rwanda FDA Wholesale License", "status": "VALID", "note": "Active" },
      { "item": "Tender Security Guarantee (RWF 3,200,000)", "status": "VALID", "note": "Issued" }
    ],
    "missing_products": [],
    "critical_gaps": "None.",
  ...
  },
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Framework contract for provision of medical oxygen to NNPTH", "security_rwf": 4500000, "place": "NNPTH Ndera", "delivery_days": 365, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "Gas Purity", "req": "Medical oxygen gas purity >= 99.5% v/v", "sup": "99.8% medical oxygen with certified cylinder batch certificates", "status": "COMPLIANT", "notes": "Exceeds standard" }
        ]
      }
    ],
    "brand_equivalence_matrix": [
    ...
    "compliance_checklist": [
      { "item": "Rwanda Standards Board (RSB) Quality Mark", "status": "VALID", "note": "Certified" },
      { "item": "Tender Security Guarantee (RWF 4,500,000)", "status": "VALID", "note": "Ready" }
    ],
    "missing_products": [],
    "critical_gaps": "None.",
  ...
  },
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Supply and installation of Hospital EMRS and Imaging software, Migration: System Reinstallation & Configuration", "security_rwf": 2306753, "place": "CHUK Masaka", "delivery_days": 60, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "DICOM & HL7 Interoperability", "req": "Full DICOM 3.0 conformance with bi-directional HL7 EMR interface", "sup": "DICOM Store, Query/Retrieve, Worklist (MWL), MPPS, HL7 FHIR v4", "status": "COMPLIANT", "notes": "Full interoperability" }
        ]
      }
    ],
    "brand_equivalence_matrix": [
    ...
    "compliance_checklist": [
      { "item": "Certified Software Integration Agreement", "status": "VALID", "note": "On file" },
      { "item": "Tender Security Guarantee (RWF 2,306,753)", "status": "VALID", "note": "Issued" }
    ],
    "missing_products": [],
    "critical_gaps": "None.",
  ...
  },
  {
    ...
    "lots": [
      { "lot_no": 1, "name": "Supply and installation of IT equipment for CHUK", "security_rwf": 15099425, "place": "CHUK Masaka", "delivery_days": 60, "coverage_status": "COMPLIANT" }
    ],
    "items": [
      {
        "lot_id": "Lot 1",
        ...
        "specs_matrix": [
          { "param": "Display Resolution & Calibration", "req": "Minimum 5MP (2560x2048) resolution with hardware DICOM Part 14 calibration", "sup": "5MP IPS medical panel, 1000 cd/m2 brightness, built-in front sensor calibration", "status": "COMPLIANT", "notes": "Exceeds standard" }
        ]
      }
    ],
    "brand_equivalence_matrix": [
    ...
    "compliance_checklist": [
      { "item": "Authorized OEM Hardware Partnership", "status": "VALID", "note": "Verified" },
      { "item": "Tender Security Guarantee (RWF 15,099,425)", "status": "VALID", "note": "Ready for issuance" }
    ],
    "missing_products": [],
    "critical_gaps": "None.",
...
with open("scratch/tenders_clean.js", "w", encoding="utf-8") as f:
    f.write("let tenders = " + json.dumps(tenders, indent=2) + ";\n")
print(f"Generated clean JS dataset with {len(tenders)} genuine Umucyo tenders.")
