...
# Comprehensive list of clinical tender templates with realistic Rwandan procurement details
raw_tender_defs = [
  # 1. Laboratory - RMS Automated Electrophoresis
  {
  ...
  # 2. Neonatal & ICU - RSOG Infant Warmers
  {
  ...
  # 3. Imaging & Radiology - CHUK 1.5T MRI
  {
  ...
  # 4. Renal Care - KFH Hemodialysis & RO
  {
  ...
  # 5. Medical Gas & Infrastructure - Ruhengeri PSA Oxygen Plant
  {
...
print(f"Total core tenders defined: {len(raw_tender_defs)}")
