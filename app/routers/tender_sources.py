...
def seed_default_sources(db: Session):
    ...
    defaults = [
        ...
        {
            "name": "Job in Rwanda - Health & NGO Tenders (PIH/IMB Channel)",
            "code": "PIH-IMB-PROC",
            "organization": "Partners In Health / Inshuti Mu Buzima",
            "website": "https://www.jobinrwanda.com/job/tender-notice-supply-and-delivery-mch-medications-kayonza-imb-warehouse",
            "url": "https://www.jobinrwanda.com/job/tender-notice-supply-and-delivery-mch-medications-kayonza-imb-warehouse",
            "scraper_type": "webpage",
            "category": SourceCategory.NGO,
            "collection_method": CollectionMethod.WEBPAGE,
            "is_active": True,
        ...
        {
            "name": "Job in Rwanda - Health & NGO Tenders (Health Builders Channel)",
            "code": "HEALTH-BUILDERS-RW",
            "organization": "Health Builders Primary Healthcare Initiative",
            "website": "https://www.jobinrwanda.com/jobs/tender",
        ...
        {
            "name": "United Nations Global Marketplace (UNGM - UNHCR Rwanda Health)",
            "code": "UNHCR-RW-HEALTH",
            "organization": "UNHCR Rwanda Representation / UNGM",
        ...
        {
            "name": "Job in Rwanda - Health & NGO Tenders (RSOG Channel)",
            "code": "RSOG-MATERNAL",
            "organization": "Rwanda Society of Obstetricians and Gynecologists",
            "website": "https://www.jobinrwanda.com/jobs/tender",
            "url": "https://www.jobinrwanda.com/jobs/tender",
            "scraper_type": "webpage",
            "category": SourceCategory.NGO,
            ...
            "tenders_collected_count": 2,
        },
        {
            "name": "Society for Family Health (SFH) - Official Tenders Board",
            "code": "SFH-RW-HEALTH",
            "organization": "Society for Family Health Rwanda",
            "website": "https://sfhrwanda.org.rw/tenders",
            "url": "https://sfhrwanda.org.rw/tenders",
            "scraper_type": "webpage",
            "category": SourceCategory.NGO,
            "collection_method": CollectionMethod.WEBPAGE,
            "is_active": True,
